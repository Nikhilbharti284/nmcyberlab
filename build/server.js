...
exports.createApp = exports.close = exports.start = void 0;
/*
...
function configureApp(app, seq) {
    ...
    app.get('/rest/user/whoami', security.updateAuthenticatedUsers(), utils.asyncHandler((0, currentUser_1.retrieveLoggedInUser)()));
    ...
    app.get('/profile', security.updateAuthenticatedUsers(), utils.asyncHandler((0, userProfile_1.getUserProfile)()));
