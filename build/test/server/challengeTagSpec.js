        ...
        challenges.forEach((challenge) => {
            if (challenge.tags) {
                challenge.tags.forEach((tag) => {
                    ...
                    (0, chai_1.expect)(en[tagKey], `Challenge "${challenge.name}" uses unsupported tag "${tag}". Only tags listed at https://pwning.owasp-juice.shop/companion-guide/latest/part1/challenges.html#_challenge_tags may be used. Tag Key: ${tagKey}`).to.not.equal(undefined);
                });
            }
        });
    });
